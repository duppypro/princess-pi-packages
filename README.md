...
| **`dedupwcount` (CLI)** | `dedupwcount` (shell command) | Stream log compressor for `tail -f` style workflows. Collapses duplicate lines into live `☝️ +N` updates with numeric/letter range summaries. |
