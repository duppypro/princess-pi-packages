# Pi Extension API Lessons & Duppy's Standards

This file contains the detailed technical lessons, TUI rendering constraints, and custom preferences developed with Duppy. 

Do not load this file into the prompt context unless specifically asked about Pi's extension behaviors, color rendering, or custom VPS configurations.
